...
function RayfieldLibrary:CreateWindow(Settings)
	...
	-- Topbar.Theme.ImageTransparency = 1 -- Removed for compatibility
	...
	wait(0.1)
	-- TweenService:Create(Topbar.Theme, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {ImageTransparency = 0.8}):Play() -- Removed for compatibility
	wait(0.1)
