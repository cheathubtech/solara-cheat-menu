...
av.Parent=ar.UIElements.Main
aw.Parent=av
ax.Parent=ar.UIElements.Main
...
ImageTransparency=ar.Transparent and aq.WindUI.TransparencyValue or 0.05
},{
l
})
end
...
ar.UIElements.Main.Background.ImageTransparency=r and aq.WindUI.TransparencyValue or 0.05
