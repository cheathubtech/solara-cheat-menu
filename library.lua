...
ImageTransparency=ar.Transparent and aq.WindUI.TransparencyValue or 0.3
},{
l
})
end
...
ar.UIElements.Main.Background.ImageTransparency=r and aq.WindUI.TransparencyValue or 0.3
